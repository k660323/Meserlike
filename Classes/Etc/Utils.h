...
public:
	...
	//static Animation* SimpleCreateAnimation(Sprite* sprite, float sizeY, float sizeX, int minY, int maxY, int minX, int maxX, float delayPerUnit = 1.0f)
	//{
	//	return SimpleCreateAnimation(sprite->getTexture(), sizeY, sizeX, minY, maxY, minX, maxX, delayPerUnit);
	//}
